...
public class AnnouncementManagementControllerTest {
    ...
    class UpdatingAnnouncement {
        ...
        void updateAnnouncementSuccessfully() throws Exception {
            ...
            UpdatingAnnouncementDto updatingAnnouncement = new UpdatingAnnouncementDto();
            ...
            updatingAnnouncement.setRemovedChanels(List.of(AnnouncementChannel.STUDENTS.name()));
